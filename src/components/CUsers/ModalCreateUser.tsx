...
const DEFAULT_VALUES: IUser = {
  ...
  customSettingsData: {
    ...
    hasTurnOverAssetPermission: "false",
    hasPurchaseAssetPermission: "false",
    hasDonationAssetPermission: "false",
  },
};

const ModalCreateUser: React.FC<IModalProps> = ({
  title,
  isModalOpen,
  setModalOpen,
  overloadOnFinish = () => {},
  ...
  const onFinish = async (values: IUser) => {
    setSubmitting(true);
    const endpoint = ENDPOINTS.user.createUser;
    ...
    const customSettingsDataFormOfficeAdmin = {
      hasCurrentInventoryAccess: "false",
