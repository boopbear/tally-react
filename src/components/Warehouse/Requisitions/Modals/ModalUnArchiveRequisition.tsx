...
const ModalUnArchiveRequisition: React.FC<IModalProps> = ({
  title = "Show requisition log",
  overloadOnFinish = () => {},
  isModalOpen,
  setModalOpen,
  mainForm: form,
  ...
  const onFinish = async (values: IWarehouseLog) => {
    setModalOpen(true);
    const endpoint = ENDPOINTS.warehouse.unArchiveTransact;
...
export default ModalUnArchiveRequisition;
